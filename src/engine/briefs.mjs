 ...
 * the produced artifact as `deliberate/briefs/<YYYY-MM-DD[-N]>/brief.md`, where the folder
 * is the last day of the reported window rather than the day it was generated and reruns
