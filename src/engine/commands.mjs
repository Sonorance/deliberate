...
export const SKILL_COMMANDS = [
  ...
  ['/deliberate init', 'Create or refresh the current repo’s product context using the latest installed Deliberate method (you read the evidence + write the context).'],
...
export const SKILL_FOLLOW_UPS = [
  ...
  ['/deliberate init', 'In create mode, ask to run the first landscape brief (**Run brief** default / **Not now**). In refresh mode, ask to open the refreshed context in Sonorance (**Open for review** default / **Not now**).'],
...
export const CLI_COMMANDS = [
  ...
  ['init', 'Set up the current folder or prepare its existing product context for refresh; name = folder.'],
  ['init prompt', 'Print the latest Initiator method and context contracts for the host to create or refresh product.md + competitors.md + ecosystem.md.'],
