...
export const FS_LAYOUT = [
  ...
  ['.sonorance/sources.md', 'The project’s categorized external grounding sources from outside the current project folder — hand-editable Markdown grouped into product, code, data, customer, go-to-market, and other sections. Committed.'],
