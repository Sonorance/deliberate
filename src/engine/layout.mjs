...
export const FS_LAYOUT = [
  ...
  ['deliberate/briefs/<YYYY-MM-DD>/brief.md', 'A landscape brief — competitive + market changes for the selected period (90-day first-run default). The folder is the last day of the reported period, not the day the brief was produced.'],
